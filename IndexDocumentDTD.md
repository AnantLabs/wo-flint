# Index Documents Schema #

Flint uses a simple [DTD](http://www.weborganic.org/schema/flint/index-documents-1.0.dtd) for the index xml or **IXML** document format.
...
<!-- System:        Flint                                                   --> 
<!-- Status:        Draft                                                   --> 
<!-- Description:   A schema for the defining a collection of indexable     --> 
<!--                Lucene documents.                                       --> 
<!-- Version:       1.0                                                     --> 
<!-- LastModified:  15 October 2009                                         --> 
...
<!--
  Lucene 2 Field Store
   - compress: Store the field value in the index in a compressed form.
   - no:       Do not store the field value in the index.
   - yes:      Store the original field value in the index.
--> 
<!ENTITY  % FIELD_STORE     "( compress | no | yes )"                         > 
 
<!--
  Lucene 2 Field Index
   - no:           Do not index the field value
   - no-norms:     Index the tokens generated by an Analyzer, but disable the storing of norms.
   - tokenised:    Index the tokens generated by an Analyzer.
   - un-tokenised: Index the field's value without using an Analyzer.
--> 
<!ENTITY  % FIELD_INDEX     "( no | no-norms | tokenised | un-tokenized )"    > 
